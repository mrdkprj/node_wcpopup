...
var Menu = /** @class */ (function () {
    ...
    Menu.prototype.remove = function (item) {
        this.ready();
        this.toMenuItem(index_1.default.remove(this.hwnd, item));
    };
    Menu.prototype.removeFrom = function (hwnd, item) {
        this.ready();
        this.toMenuItem(index_1.default.remove(hwnd, item));
    };
    Menu.prototype.removeAt = function (index) {
        this.ready();
        this.toMenuItem(index_1.default.removeAt(this.hwnd, index));
    };
    Menu.prototype.removeAtFrom = function (hwnd, index) {
        this.ready();
        this.toMenuItem(index_1.default.removeAt(hwnd, index));
    };
