...
var index_1 = __importDefault(require("../build/index"));
var UUID = "MenuItem";
...
var Menu = /** @class */ (function () {
    ...
    Menu.prototype.items = function () {
        this.ready();
        return index_1.default.items(this.hwnd);
    };
    Menu.prototype.remove = function (item) {
        this.ready();
        return index_1.default.remove(this.hwnd, item);
    };
    Menu.prototype.removeFrom = function (hwnd, item) {
        this.ready();
        return index_1.default.remove(hwnd, item);
    };
    Menu.prototype.removeAt = function (index) {
        this.ready();
        return index_1.default.removeAt(this.hwnd, index);
    };
    Menu.prototype.removeAtFrom = function (hwnd, index) {
        this.ready();
        return index_1.default.removeAt(hwnd, index);
    };
    ...
    Menu.prototype.getMenuItemById = function (id) {
        this.ready();
        return index_1.default.getMenuItemById(this.hwnd, id);
    };
    return Menu;
}());
exports.Menu = Menu;
