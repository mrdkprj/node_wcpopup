...
var Menu = /** @class */ (function () {
    ...
    Menu.prototype.popupSync = function (x, y) {
        this.ready();
        var result = PopupMenu.popupSync(this.hwnd, x, y);
        if (Object.keys(result).length) {
            this.callbacks[result.id](result);
        }
    };
    ...
    Menu.prototype.appendTo = function (hwnd, item) {
        this.ready();
        PopupMenu.append(hwnd, this.toEffectiveTemplate(item));
    };
    ...
    Menu.prototype.insertTo = function (hwnd, index, item) {
        this.ready();
        PopupMenu.insert(hwnd, index, this.toEffectiveTemplate(item));
    };
